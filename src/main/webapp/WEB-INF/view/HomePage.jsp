		...
		<div
			...
			<div
				...
				<div class="flex-fill">
					...
					<form action="sportEquipment/search" method="post">
					...
					<div class="col-12 col-md-4 mb-4">
						<div class="card h-100">
							...
							<div class="card-body">
								...
								<a href="${pageContext.request.contextPath}//sportEquipment/showDetail?sportEquipmentId=${product.id}">Xem chi tiet</a>
							</div>
						</div>
					</div>
				</c:forEach>
